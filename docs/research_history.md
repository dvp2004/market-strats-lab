# Market Strats Lab Research History

This file preserves the detailed pre-consolidation research narrative formerly held in the
top-level README. Current architecture, operating boundaries, and commands are documented in
the concise repository README and focused documents under `docs/`.

## Pre-consolidation narrative
