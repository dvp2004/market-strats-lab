        ...
        rows.append(
            {
                ...
                "raw_inputs": ["adjusted_close"] if family_id == "technical" else ["macro_series"],
...
def _output_schema():
    ...
    return [{"column_name": column, "dtype": "string", "required": True} for column in columns]
...
def _config(tmp_path: Path):
    return {
        ...
        "phase13f_feature_schema_readiness_visual_template_audit": {"enabled": False},
        "phase13g_feature_calculation_preregistration_spec": {
            ...
            "source_reports": {
                "phase13f_conclusion": str(tmp_path / "phase13f_schema_audit_conclusion.csv"),
                "phase13f_gate_report": str(tmp_path / "phase13f_schema_audit_gate_report.csv"),
        ...
        "phase13h_feature_calculation_readiness_audit": {
            ...
            "phase13g_reports": {
                "source_report_check": str(tmp_path / "phase13g_prereg_source_report_check.csv"),
                ...
                "scope_boundary_check": str(tmp_path / "phase13g_prereg_scope_boundary_check.csv"),
            ...
            "phase13i_boundary": {
                "allowed_next_step": ("Technical and macro feature calculation execution only"),
                "forbidden_next_step": (
