...
def _write_prior_reports(tmp_path: Path):
    for name, phase, verdict in [
        (
            "phase13x_checkpoint_conclusion.csv",
            "Phase 13X",
        ...
        pd.DataFrame(
            [{"phase": phase, "verdict": verdict, "all_gates_passed": True, "passed": True}]
    ...
    return {
        ...
        "phase13y_ml_diagnostic_repair_preregistration": {
            ...
            "registered_repair_hypotheses": [
                {
                    "repair_id": "rf_repair_shallow_regularised",
                    "base_model_family": "random_forest",
                    "allowed": True,
                    "max_depth": 2,
                    "min_samples_leaf": 20,
                    "n_estimators": 20,
                ...
                {
                    "repair_id": "logistic_repair_high_regularisation",
                    "base_model_family": "logistic_regression",
                    "allowed": True,
                    "C": 0.25,
                    "max_iter": 500,
                },
                {
                    ...
                    "base_model_family": "hist_gradient_boosting",
                    "allowed": True,
                    "max_iter": 20,
                    "learning_rate": 0.03,
                    "max_leaf_nodes": 7,
            ...
            "phase13z_boundary": {
                "allowed_next_step": "ML diagnostic repair readiness and boundary audit only"
            },
            "phase13aa_boundary": {
                "allowed_future_step": "Registered ML diagnostic repair execution on train/validation only"
            },
        },
        "phase13z_ml_diagnostic_repair_readiness_audit": {
            ...
            "phase13y_reports": {
                ...
                "repair_hypothesis_registry": str(
                    tmp_path / "phase13y_repair_prereg_hypothesis_registry.csv"
                ),
                "repair_success_gate_registry": str(
                    tmp_path / "phase13y_repair_prereg_success_gate_registry.csv"
                ),
            },
        },
        ...
        "phase13ab_ml_diagnostic_repair_result_audit": {
            ...
            "phase13aa_reports": {
                ...
                "validation_predictions": str(
                    tmp_path / "phase13aa_repair_execution_validation_predictions.csv"
                ),
            },
        },
    }
...
def test_phase13y_to_13ab_repair_bundle(tmp_path):
    ...
    out_aa = save_phase13aa_registered_ml_diagnostic_repair_execution(
